...
#include <memory>
#include "../Malnati_Client/socketmanager.h"
...
QT_MOC_LITERAL(3, 26, 8), // "Message*"
QT_MOC_LITERAL(4, 35, 1), // "m"
QT_MOC_LITERAL(5, 37, 15), // "messageToServer"
QT_MOC_LITERAL(6, 53, 11), // "onConnected"
QT_MOC_LITERAL(7, 65, 21), // "onTextMessageReceived"
QT_MOC_LITERAL(8, 87, 7) // "message"

    },
    "socketManager\0newMessage\0\0Message*\0m\0"
    "messageToServer\0onConnected\0"
...
void socketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newMessage((*reinterpret_cast< Message*(*)>(_a[1]))); break;
        case 1: _t->messageToServer((*reinterpret_cast< Message*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (socketManager::*)(Message * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&socketManager::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void socketManager::newMessage(Message * _t1)
{
